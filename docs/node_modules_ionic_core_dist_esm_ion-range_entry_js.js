...
/* harmony import */ var _form_controller_548aa79c_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form-controller-548aa79c.js */ 2997);
...
/* harmony import */ var _dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dir-babeabeb.js */ 7632);
...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionInput = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionInput", 7);
    ...
    this.ionKnobMoveStart = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveEnd", 7);
    ...
    this.clampBounds = value => {
      return (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,D_Documents_WebSite_shahidfoy_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.j)(ionInput, debounce);
  }
  minChanged() {
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  connectedCallback() {
    ...
    this.legacyFormController = (0,_form_controller_548aa79c_js__WEBPACK_IMPORTED_MODULE_3__.c)(el);
    this.updateRatio();
    ...
    this.contentEl = (0,_index_b9e742e5_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_b9e742e5_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    const rect = this.rect = this.rangeSlider.getBoundingClientRect();
    const currentX = detail.currentX;
    // figure out which knob they started closer to
    let ratio = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (currentX - rect.left) / rect.width, 1);
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_b9e742e5_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
    }
    this.update(detail.currentX);
    this.pressedKnob = undefined;
    this.emitValueChange();
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
    ...
    (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.d)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      name: "start"
    }), this.renderRangeSlider(), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "end"
    }));
  }
  /**
  ...
  renderRange() {
    ...
    return (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      part: "label"
    }, label !== undefined ? (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "label-text"
    }, label) : (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "label"
    })), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderRangeSlider() {
    ...
    let {
      labelText
    } = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.e)(el, rangeId);
    ...
    }, ticks.map(tick => (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.l)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss,
