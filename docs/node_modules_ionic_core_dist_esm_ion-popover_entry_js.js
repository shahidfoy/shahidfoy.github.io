...
/* harmony import */ var _framework_delegate_bc1fd82a_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-bc1fd82a.js */ 8573);
...
/* harmony import */ var _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-9b0d46f4.js */ 6240);
...
/* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-01f3f29c.js */ 5107);
/* harmony import */ var _index_1932b201_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-1932b201.js */ 4347);
/* harmony import */ var _animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation-dde8cc0d.js */ 2723);
/* harmony import */ var _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-a5d50daf.js */ 6940);
/* harmony import */ var _hardware_back_button_b2bc76db_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hardware-back-button-b2bc76db.js */ 1940);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,D_Documents_WebSite_shahidfoy_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const focusItem = item => {
  const root = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => button.focus());
  }
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
  ...
  const baseAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const backdropAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const wrapperAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const contentAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  const viewportAnimation = (0,_animation_dde8cc0d_js__WEBPACK_IMPORTED_MODULE_10__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidDismiss", 7);
    ...
    this.coreDelegate = (0,_framework_delegate_bc1fd82a_js__WEBPACK_IMPORTED_MODULE_2__.C)();
  ...
  connectedCallback() {
    ...
    (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_c0cda98e_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
    ...
    if (parentPopover) {
      (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.a)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  present(event) {
    ...
    return (0,D_Documents_WebSite_shahidfoy_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_bc1fd82a_js__WEBPACK_IMPORTED_MODULE_2__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
       ...
       */
      if ((0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.m)(el)) {
        yield (0,_index_1932b201_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_1932b201_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      yield (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.o)(_this2.el, _this2.el);
      }
      unlock();
    })();
  }
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,D_Documents_WebSite_shahidfoy_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const shouldDismiss = yield (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
        ...
        yield (0,_framework_delegate_bc1fd82a_js__WEBPACK_IMPORTED_MODULE_2__.d)(delegate, _this3.usersElement);
      }
      unlock();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_32ef481d_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_c0cda98e_js__WEBPACK_IMPORTED_MODULE_7__.a)('desktop');
    ...
    }), !parentPopover && (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
    ...
    }, enableArrow && (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "popover-arrow",
      part: "arrow"
    }), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
