...
const Radio = class {
  ...
  connectedCallback() {
    this.legacyFormController = (0,_form_controller_548aa79c_js__WEBPACK_IMPORTED_MODULE_2__.c)(this.el);
    ...
    if (radioGroup) {
      this.updateState();
      (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.a)(radioGroup, 'ionValueChange', this.updateState);
    }
  }
  disconnectedCallback() {
    const radioGroup = this.radioGroup;
    if (radioGroup) {
      (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.b)(radioGroup, 'ionValueChange', this.updateState);
      this.radioGroup = null;
    }
  }
  componentWillLoad() {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new radio syntax.`, this.el);
    ...
    }, this.renderRadioControl(), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
...
const RadioGroup = class {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_c0cda98e_js__WEBPACK_IMPORTED_MODULE_7__.b)(this);
    (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, value, false);
    return (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      role: "radiogroup",
      "aria-labelledby": label ? labelId : null,
      onClick: this.onClick,
