...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_c132c5f1_js__WEBPACK_IMPORTED_MODULE_8__.f : _index_c132c5f1_js__WEBPACK_IMPORTED_MODULE_8__.r;
      }
      return checked ? _index_c132c5f1_js__WEBPACK_IMPORTED_MODULE_8__.r : _index_c132c5f1_js__WEBPACK_IMPORTED_MODULE_8__.g;
    };
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_c0cda98e_js__WEBPACK_IMPORTED_MODULE_9__.c.get('toggleOnOffLabels');
  ...
  connectedCallback() {
    ...
    return (0,D_Documents_WebSite_shahidfoy_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.legacyFormController = (0,_form_controller_548aa79c_js__WEBPACK_IMPORTED_MODULE_2__.c)(_this2.el);
      /**
  ...
  componentWillLoad() {
    ...
    if (!this.legacyFormController.hasLegacyControl()) {
      this.inheritedAttributes = Object.assign({}, (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el));
    }
  }
  emitStyle() {
    if (this.legacyFormController.hasLegacyControl()) {
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, checked ? value : '', disabled);
    ...
    }, this.inheritedAttributes)), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !this.hasLabel
      },
      part: "label"
    }, (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", null)), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    const {
      ...
      labelId,
      labelText
    } = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.e)(el, inputId);
    const value = this.getValue();
    const rtl = (0,_dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_6__.i)(el) ? 'rtl' : 'ltr';
    (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, checked ? value : '', disabled);
    return (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.H, {
    ...
    }, this.renderToggleControl(), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
    }, labelText), (0,_index_08d686eb_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
