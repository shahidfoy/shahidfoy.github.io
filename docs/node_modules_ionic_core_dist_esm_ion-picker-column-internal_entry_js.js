...
/* harmony import */ var _haptic_554688a5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-554688a5.js */ 6814);
...
/* harmony import */ var _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-a5d50daf.js */ 6940);
...
const PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
       ...
       */
      const enableHaptics = (0,_ionic_global_c0cda98e_js__WEBPACK_IMPORTED_MODULE_4__.a)('ios');
      const {
        el
      } = this;
      let timeout;
  ...
  componentWillLoad() {
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_2__.g)(el).querySelector(`.${PICKER_ITEM_ACTIVE_CLASS}`);
        if (oldActive) {
  ...
  get activeItem() {
    ...
    return (0,_helpers_ae653409_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(selector);
  }
  render() {
    const {
      items,
